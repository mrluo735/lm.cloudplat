...
public class RequestDTO implements Serializable {
	...
	private ContextDTO<String> context = new ContextDTO<>();
	 ...
	 * @param context
	 */
	public <T> RequestDTO(String method, ContextDTO<String> context) {
		this.method = method;
	 ...
	 * @return
	 */
	public ContextDTO<String> getContext() {
		return context;
	}
	 ...
	 * @param context
	 */
	public void setContext(ContextDTO<String> context) {
		this.context = context;
	}
