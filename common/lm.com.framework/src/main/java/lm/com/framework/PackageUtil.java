	...
	public static List<String> getClassNameByFile(String filePath, List<String> className, boolean childPackage) {
		...
		for (File childFile : childFiles) {
			if (childFile.isDirectory()) {
				...
				final String classesSeparator = "classes" + JavaUtil.getFileSeparator();
				...
				if (childFilePath.endsWith(".class")) {
					...
					if (index != -1) {
						...
						childFilePath = childFilePath.replace(JavaUtil.getFileSeparator(), ".");
