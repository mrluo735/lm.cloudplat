 ...
 * <p>
 * 分布式唯一ID生成器<br/>
 * 基于Twitter的Snowflake idworker实现
 * </p>
 ...
 * <p>
 * 64位ID (42(毫秒)+5(机器ID)+5(业务编码)+12(重复累加))<br/>
 * 字符串长度为18
 * 
 * @author mrluo735
 *
...
public class IdWorker {
	...
	// System.out.println("id1=" + id.nextId());
	// System.out.println("id2=" + id.nextId());
	// System.out.println("id3=" + id.nextId());
